...
/*     */ 
/*     */   
/*  97 */   private static final int[][] CHAR_MAP = new int[5][256];
/*     */   static {
/*  99 */     CHAR_MAP[0][32] = 1; int c;
/* 100 */     for (c = 65; c <= 90; c++) {
...
/*     */ 
/*     */     
/* 118 */     for (int i = 0; i < mixedTable.length; i++) {
...
/*     */     int k;
/*     */     
/* 126 */     for (k = 0; k < punctTable.length; k++) {
...
/*     */ 
/*     */   
/* 135 */   static final int[][] SHIFT_TABLE = new int[6][6];
/*     */   static {
/* 137 */     for (int arrayOfInt[][] = SHIFT_TABLE, j = arrayOfInt.length; k < j; ) { int[] table = arrayOfInt[k];
/* 138 */       Arrays.fill(table, -1); k++; }
/*     */     
...
/*     */     } 
/*     */     
/* 192 */     State minState = Collections.<State>min(states, new Comparator<State>()
/*     */         {
/*     */           public int compare(State a, State b) {
/* 195 */             return a.getBitCount() - b.getBitCount();
/*     */           }
/*     */         });
/*     */     
/* 199 */     return minState.toBitArray(this.text);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 221 */       int charInMode = CHAR_MAP[mode][ch];
/* 222 */       if (charInMode > 0) {
...
/* 256 */     for (State state : states) {
/* 257 */       updateStateForPair(state, index, pairCode, result);
/*     */     }
...
/* 291 */         State oldState = iterator.next();
/* 292 */         if (oldState.isBetterThanOrEqualTo(newState)) {
/* 293 */           add = false;
/*     */           break;
/*     */         } 
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\google\zxing\aztec\encoder\HighLevelEncoder.class
