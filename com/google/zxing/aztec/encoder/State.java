...
/*     */ 
/*     */     
/* 117 */     State result = new State(token, mode, this.binaryShiftByteCount + 1, bitCount + deltaBitCount);
/* 118 */     if (result.binaryShiftByteCount == 2078)
/*     */     {
...
/* 129 */       return this;
/*     */     }
/* 131 */     Token token = this.token;
/* 132 */     token = token.addBinaryShift(index - this.binaryShiftByteCount, this.binaryShiftByteCount);
/*     */     
...
/*     */     
/* 157 */     for (Token symbol : symbols) {
/* 158 */       symbol.appendTo(bitArray, text);
/*     */     }
/*     */     
/* 161 */     return bitArray;
/*     */   }
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\google\zxing\aztec\encoder\State.class
