...
/*  45 */     BarcodeFormat format = result.getBarcodeFormat();
/*  46 */     if (format != BarcodeFormat.RSS_EXPANDED)
/*     */     {
/*  48 */       return null;
/*     */     }
...
/*  70 */       String ai = findAIvalue(i, rawText);
/*  71 */       if (ai == null)
/*     */       {
/*     */         
/*  74 */         return null;
/*     */       }
/*  76 */       i += ai.length() + 2;
/*  77 */       String value = findValue(i, rawText);
/*  78 */       i += value.length();
/*     */       
/*  80 */       switch (ai) {
/*     */         case "00":
...
/* 186 */       char currentChar = rawTextAux.charAt(index);
/* 187 */       if (currentChar == ')')
...
/* 203 */       char c = rawTextAux.charAt(index);
/* 204 */       if (c == '(') {
/*     */ 
/*     */         
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\google\zxing\client\result\ExpandedProductResultParser.class
