...
/*     */     
/*  74 */     GenericGFPoly[] sigmaOmega = runEuclideanAlgorithm(this.field.buildMonomial(twoS, 1), syndrome, twoS);
...
/*  80 */       int position = received.length - 1 - this.field.log(errorLocations[j]);
/*  81 */       if (position < 0) {
...
/*     */ 
/*     */           
/* 176 */           int term = this.field.multiply(errorLocations[j], xiInverse);
/* 177 */           int termPlus1 = ((term & 0x1) == 0) ? (term | 0x1) : (term & 0xFFFFFFFE);
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\google\zxing\common\reedsolomon\ReedSolomonDecoder.class
