...
/*     */     while (true) {
/* 131 */       int oneByte = bits.readBits(8);
/* 132 */       if (oneByte == 0)
...
/*     */         return;
/*     */       }
/* 205 */       int firstByte = bits.readBits(8);
/* 206 */       if (firstByte == 254) {
/*     */         return;
/*     */       }
/*     */       
...
/*     */         return;
/*     */       }
/* 289 */       int firstByte = bits.readBits(8);
/* 290 */       if (firstByte == 254) {
/*     */         return;
/*     */       }
/*     */       
...
/*     */         return;
/*     */       }
/* 377 */       int firstByte = bits.readBits(8);
/* 378 */       if (firstByte == 254) {
/*     */         return;
/*     */       }
/*     */       
...
/* 406 */     int fullBitValue = (firstByte << 8) + secondByte - 1;
/* 407 */     int temp = fullBitValue / 1600;
/* 408 */     result[0] = temp;
/* 409 */     fullBitValue -= temp * 1600;
/* 410 */     temp = fullBitValue / 40;
/* 411 */     result[1] = temp;
...
/* 426 */         int edifactValue = bits.readBits(6);
/*     */ 
/*     */         
/* 429 */         if (edifactValue == 31) {
/*     */           
/* 431 */           int bitsLeft = 8 - bits.getBitOffset();
/* 432 */           if (bitsLeft != 8) {
...
/* 455 */     int d1 = unrandomize255State(bits.readBits(8), codewordPosition++);
/*     */     
/* 457 */     if (d1 == 0) {
...
/*     */     try {
/* 481 */       result.append(new String(bytes, "ISO8859_1"));
...
/* 492 */     int pseudoRandomNumber = 149 * base256CodewordPosition % 255 + 1;
/* 493 */     int tempVariable = randomizedBase256Codeword - pseudoRandomNumber;
/* 494 */     return (tempVariable >= 0) ? tempVariable : (tempVariable + 256);
/*     */   }
/*     */ }


/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\google\zxing\datamatrix\decoder\DecodedBitStreamParser.class
