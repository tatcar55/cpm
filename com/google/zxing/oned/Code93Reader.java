...
/*     */ 
/*     */   
/*  47 */   private static final int[] CHARACTER_ENCODINGS = new int[] { 276, 328, 324, 322, 296, 292, 290, 336, 274, 266, 424, 420, 418, 404, 402, 394, 360, 356, 354, 308, 282, 344, 332, 326, 300, 278, 436, 434, 428, 422, 406, 410, 364, 358, 310, 314, 302, 468, 466, 458, 366, 374, 430, 294, 474, 470, 306, 350 };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  55 */   private static final int ASTERISK_ENCODING = CHARACTER_ENCODINGS[47];
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/*  74 */     int[] theCounters = this.counters;
/*  75 */     Arrays.fill(theCounters, 0);
/*  76 */     StringBuilder result = this.decodeRowResult;
...
/*  99 */         for (int counter : theCounters) {
...
/* 166 */     int max = counters.length;
/* 167 */     int sum = 0;
/* 168 */     for (int counter : counters) {
/* 169 */       sum += counter;
/*     */     }
/* 171 */     int pattern = 0;
/* 172 */     for (int i = 0; i < max; i++) {
/* 173 */       int scaled = Math.round(counters[i] * 9.0F / sum);
/* 174 */       if (scaled < 1 || scaled > 4) {
/* 175 */         return -1;
/*     */       }
/* 177 */       if ((i & 0x1) == 0) {
/* 178 */         for (int j = 0; j < scaled; j++) {
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\google\zxing\oned\Code93Reader.class
