...
/*  63 */         encoder.setCompact(((Boolean)hints.get(EncodeHintType.PDF417_COMPACT)).booleanValue());
/*     */       }
/*  65 */       if (hints.containsKey(EncodeHintType.PDF417_COMPACTION)) {
/*  66 */         encoder.setCompaction((Compaction)hints.get(EncodeHintType.PDF417_COMPACTION));
/*     */       }
...
/*  76 */         margin = ((Number)hints.get(EncodeHintType.MARGIN)).intValue();
/*     */       }
/*  78 */       if (hints.containsKey(EncodeHintType.ERROR_CORRECTION)) {
/*  79 */         errorCorrectionLevel = ((Number)hints.get(EncodeHintType.ERROR_CORRECTION)).intValue();
/*     */       }
/*  81 */       if (hints.containsKey(EncodeHintType.CHARACTER_SET)) {
/*  82 */         String encoding = (String)hints.get(EncodeHintType.CHARACTER_SET);
/*  83 */         encoder.setEncoding(Charset.forName(encoding));
/*     */       } 
/*     */     } 
/*     */     
...
/*     */     
/* 109 */     int aspectRatio = 4;
/* 110 */     byte[][] originalScale = encoder.getBarcodeMatrix().getScaledMatrix(1, aspectRatio);
...
/* 127 */     if (scale > 1) {
/*     */       
/* 129 */       byte[][] scaledMatrix = encoder.getBarcodeMatrix().getScaledMatrix(scale, scale * aspectRatio);
/* 130 */       if (rotated) {
...
/* 147 */     BitMatrix output = new BitMatrix((input[0]).length + 2 * margin, input.length + 2 * margin);
/* 148 */     output.clear();
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\google\zxing\pdf417\PDF417Writer.class
