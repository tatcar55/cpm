...
/*  86 */       ResultPoint top = isLeft ? this.topLeft : this.topRight;
/*  87 */       int newMinY = (int)top.getY() - missingStartRows;
/*  88 */       if (newMinY < 0) {
/*  89 */         newMinY = 0;
/*     */       }
...
/* 100 */       ResultPoint bottom = isLeft ? this.bottomLeft : this.bottomRight;
/* 101 */       int newMaxY = (int)bottom.getY() + missingEndRows;
/* 102 */       if (newMaxY >= this.image.getHeight()) {
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\google\zxing\pdf417\decoder\BoundingBox.class
