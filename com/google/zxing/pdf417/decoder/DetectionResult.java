...
/*  49 */       unadjustedCodewordCount = adjustRowNumbers();
/*  50 */     } while (unadjustedCodewordCount > 0 && unadjustedCodewordCount < previousUnadjustedCount);
...
/*  69 */     int unadjustedCount = adjustRowNumbersByRow();
/*  70 */     if (unadjustedCount == 0) {
/*  71 */       return 0;
/*     */     }
...
/*     */ 
/*     */     
/*  93 */     int unadjustedCount = adjustRowNumbersFromLRI();
/*  94 */     return unadjustedCount + adjustRowNumbersFromRRI();
/*     */   }
/*     */   
...
/* 108 */           Codeword codeword = this.detectionResultColumns[barcodeColumn].getCodewords()[codewordsRow];
/* 109 */           if (codeword != null) {
/*     */ 
/*     */             
...
/* 134 */           Codeword codeword = this.detectionResultColumns[barcodeColumn].getCodewords()[codewordsRow];
/* 135 */           if (codeword != null) {
...
/* 159 */           Codeword codeword = this.detectionResultColumns[barcodeColumn].getCodewords()[codewordsRow];
/* 160 */           if (codeword != null) {
...
/* 188 */     Codeword[] previousColumnCodewords = this.detectionResultColumns[barcodeColumn - 1].getCodewords();
/* 189 */     Codeword[] nextColumnCodewords = previousColumnCodewords;
...
/*     */     }
/*     */     
/* 194 */     Codeword[] otherCodewords = new Codeword[14];
/*     */     
/* 196 */     otherCodewords[2] = previousColumnCodewords[codewordsRow];
...
/*     */     } 
/* 219 */     for (Codeword otherCodeword : otherCodewords) {
...
/* 270 */     DetectionResultColumn rowIndicatorColumn = this.detectionResultColumns[0];
/* 271 */     if (rowIndicatorColumn == null) {
...
/*     */         } else {
/*     */           
/* 282 */           Codeword codeword = this.detectionResultColumns[barcodeColumn].getCodewords()[codewordsRow];
/* 283 */           if (codeword == null)
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\google\zxing\pdf417\decoder\DetectionResult.class
