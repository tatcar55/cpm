...
/*  38 */     if (dimension < 21 || (dimension & 0x3) != 1) {
...
/*     */     }
/*     */     
/* 102 */     int dimension = this.bitMatrix.getHeight();
/*     */     
/* 104 */     int provisionalVersion = (dimension - 17) / 4;
...
/* 141 */     boolean bit = this.mirror ? this.bitMatrix.get(j, i) : this.bitMatrix.get(i, j);
...
/*     */       return;
/*     */     }
/* 214 */     DataMask dataMask = DataMask.forReference(this.parsedFormatInfo.getDataMask());
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\google\zxing\qrcode\decoder\BitMatrixParser.class
