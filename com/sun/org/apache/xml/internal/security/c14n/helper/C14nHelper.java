...
public class C14nHelper {
  ...
  public static boolean namespaceIsAbsolute(String paramString) {
    return (paramString.length() == 0) ? true : ((paramString.indexOf(':') > 0));
  }
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\org\apache\xml\internal\security\c14n\helper\C14nHelper.class
