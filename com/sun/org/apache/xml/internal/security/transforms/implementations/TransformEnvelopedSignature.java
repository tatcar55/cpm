...
public class TransformEnvelopedSignature extends TransformSpi {
  ...
  static class EnvelopedNodeFilter implements NodeFilter {
    ...
    EnvelopedNodeFilter(Node param1Node) {
      this.exclude = param1Node;
    }
    
    public int isNodeIncludeDO(Node param1Node, int param1Int) {
      return (param1Node == this.exclude) ? -1 : 1;
    }
    
    public int isNodeInclude(Node param1Node) {
      return (param1Node == this.exclude || XMLUtils.isDescendantOrSelf(this.exclude, param1Node)) ? -1 : 1;
    }
  }
}


/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\org\apache\xml\internal\security\transforms\implementations\TransformEnvelopedSignature.class
