...
public class XPath2FilterContainer04 extends ElementProxy implements TransformParam {
  ...
  private XPath2FilterContainer04(Document paramDocument, String paramString1, String paramString2) {
    super(paramDocument);
    this._constructionElement.setAttributeNS((String)null, "Filter", paramString2);
  ...
  private XPath2FilterContainer04(Element paramElement, String paramString) throws XMLSecurityException {
    ...
    String str = this._constructionElement.getAttributeNS((String)null, "Filter");
  ...
  public boolean isIntersect() {
    return this._constructionElement.getAttributeNS((String)null, "Filter").equals("intersect");
  }
  
  public boolean isSubtract() {
    return this._constructionElement.getAttributeNS((String)null, "Filter").equals("subtract");
  }
  
  public boolean isUnion() {
    return this._constructionElement.getAttributeNS((String)null, "Filter").equals("union");
  }
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\org\apache\xml\internal\security\transforms\params\XPath2FilterContainer04.class
