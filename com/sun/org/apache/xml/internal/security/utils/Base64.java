...
public class Base64 {
  ...
  static final byte[] getBytes(BigInteger paramBigInteger, int paramInt) {
    ...
    System.arraycopy(arrayOfByte1, bool, arrayOfByte2, j, i);
    return arrayOfByte2;
  }
  ...
  public static final String encode(byte[] paramArrayOfbyte) {
    return XMLUtils.ignoreLineBreaks() ? encode(paramArrayOfbyte, 2147483647) : encode(paramArrayOfbyte, 76);
  }
  ...
  public static final byte[] decode(BufferedReader paramBufferedReader) throws IOException, Base64DecodingException {
    ...
    while (null != (str = paramBufferedReader.readLine())) {
      ...
      unsyncByteArrayOutputStream.write(arrayOfByte);
    } 
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\org\apache\xml\internal\securit\\utils\Base64.class
