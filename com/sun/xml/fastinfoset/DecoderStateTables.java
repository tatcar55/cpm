...
/*     */ {
/*  21 */   private static int RANGE_INDEX_END = 0;
/*  22 */   private static int RANGE_INDEX_VALUE = 1;
/*     */   
...
/*  53 */   private static final int[] DII = new int[256];
/*     */   
/*  55 */   private static final int[][] DII_RANGES = new int[][] { { 31, 0 }, { 39, 2 }, { 48, 3 }, { 55, 255 }, { 56, 4 }, { 59, 255 }, { 60, 5 }, { 61, 5 }, { 62, 255 }, { 63, 5 }, { 95, 1 }, { 103, 2 }, { 112, 3 }, { 119, 255 }, { 120, 4 }, { 123, 255 }, { 124, 5 }, { 125, 5 }, { 126, 255 }, { 127, 5 }, { 195, 255 }, { 199, 20 }, { 224, 255 }, { 225, 19 }, { 226, 18 }, { 239, 255 }, { 240, 22 }, { 254, 255 }, { 255, 23 } };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 340 */   private static final int[] AII = new int[256];
/*     */   
/* 342 */   private static final int[][] AII_RANGES = new int[][] { { 63, 0 }, { 95, 1 }, { 111, 2 }, { 119, 255 }, { 121, 3 }, { 122, 255 }, { 123, 3 }, { 239, 255 }, { 240, 4 }, { 254, 255 }, { 255, 5 } };
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 395 */   private static final int[] NISTRING = new int[256];
/*     */   
/* 397 */   private static final int[][] NISTRING_RANGES = new int[][] { { 7, 0 }, { 8, 1 }, { 11, 255 }, { 12, 2 }, { 15, 255 }, { 23, 3 }, { 24, 4 }, { 27, 255 }, { 28, 5 }, { 31, 255 }, { 47, 6 }, { 63, 7 }, { 71, 0 }, { 72, 1 }, { 75, 255 }, { 76, 2 }, { 79, 255 }, { 87, 3 }, { 88, 4 }, { 91, 255 }, { 92, 5 }, { 95, 255 }, { 111, 6 }, { 127, 7 }, { 191, 8 }, { 223, 9 }, { 239, 10 }, { 254, 255 }, { 255, 11 } };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 512 */   private static final int[] ISTRING = new int[256];
/*     */   
/* 514 */   private static final int[][] ISTRING_RANGES = new int[][] { { 63, 0 }, { 64, 1 }, { 95, 255 }, { 96, 2 }, { 127, 255 }, { 191, 3 }, { 223, 4 }, { 239, 5 }, { 255, 255 } };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 550 */   private static final int[] ISTRING_PREFIX_NAMESPACE = new int[256];
/*     */   
/* 552 */   private static final int[][] ISTRING_PREFIX_NAMESPACE_RANGES = new int[][] { { 1, 0 }, { 2, 6 }, { 3, 0 }, { 4, 7 }, { 27, 0 }, { 28, 8 }, { 34, 0 }, { 35, 9 }, { 63, 0 }, { 64, 1 }, { 95, 255 }, { 96, 2 }, { 127, 255 }, { 128, 10 }, { 191, 3 }, { 223, 4 }, { 239, 5 }, { 255, 255 } };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 618 */   private static final int[] UTF8_NCNAME = new int[256];
/*     */   
/* 620 */   private static final int[][] UTF8_NCNAME_RANGES = new int[][] { { 44, 255 }, { 46, 1 }, { 47, 255 }, { 57, 1 }, { 64, 255 }, { 90, 0 }, { 94, 255 }, { 95, 0 }, { 96, 255 }, { 122, 0 }, { 127, 255 }, { 193, 255 }, { 223, 2 }, { 239, 3 }, { 247, 4 }, { 255, 255 } };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 690 */   private static final int[] UTF8 = new int[256];
/*     */   
/* 692 */   private static final int[][] UTF8_RANGES = new int[][] { { 8, 255 }, { 10, 1 }, { 12, 255 }, { 13, 1 }, { 31, 255 }, { 127, 1 }, { 193, 255 }, { 223, 2 }, { 239, 3 }, { 247, 4 }, { 255, 255 } };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 743 */     int start = 0;
/* 744 */     for (int range = 0; range < ranges.length; range++) {
/* 745 */       int end = ranges[range][RANGE_INDEX_END];
/* 746 */       int value = ranges[range][RANGE_INDEX_VALUE];
...
/* 755 */     return DII[index];
/*     */   }
/*     */   
/*     */   public static final int EII(int index) {
/* 759 */     return EII[index];
/*     */   }
/*     */   
/*     */   public static final int AII(int index) {
/* 763 */     return AII[index];
/*     */   }
/*     */   
/*     */   public static final int NISTRING(int index) {
/* 767 */     return NISTRING[index];
/*     */   }
/*     */   
/*     */   public static final int ISTRING(int index) {
/* 771 */     return ISTRING[index];
/*     */   }
/*     */   
/*     */   public static final int ISTRING_PREFIX_NAMESPACE(int index) {
/* 775 */     return ISTRING_PREFIX_NAMESPACE[index];
/*     */   }
/*     */   
/*     */   public static final int UTF8(int index) {
/* 779 */     return UTF8[index];
/*     */   }
/*     */   
/*     */   public static final int UTF8_NCNAME(int index) {
/* 783 */     return UTF8_NCNAME[index];
/*     */   }
/*     */ 
/*     */   
/*     */   static {
/* 788 */     constructTable(DII, DII_RANGES);
/*     */ 
/*     */     
/* 791 */     constructTable(EII, EII_RANGES);
/*     */ 
/*     */     
/* 794 */     constructTable(AII, AII_RANGES);
/*     */ 
/*     */     
/* 797 */     constructTable(NISTRING, NISTRING_RANGES);
/*     */ 
/*     */     
/* 800 */     constructTable(ISTRING, ISTRING_RANGES);
/*     */ 
/*     */     
/* 803 */     constructTable(ISTRING_PREFIX_NAMESPACE, ISTRING_PREFIX_NAMESPACE_RANGES);
/*     */ 
/*     */     
/* 806 */     constructTable(UTF8_NCNAME, UTF8_NCNAME_RANGES);
/*     */ 
/*     */     
/* 809 */     constructTable(UTF8, UTF8_RANGES);
/*     */   }
/*     */ }


/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\xml\fastinfoset\DecoderStateTables.class
