...
/*     */   
/*     */   static {
/*  24 */     initiateXMLDeclarationValues();
/*     */   }
/*     */ 
/*     */   
/*  28 */   public static final int XML_NAMESPACE_PREFIX_LENGTH = "xml".length();
/*     */   public static final String XML_NAMESPACE_NAME = "http://www.w3.org/XML/1998/namespace";
/*  30 */   public static final int XML_NAMESPACE_NAME_LENGTH = "http://www.w3.org/XML/1998/namespace".length();
/*     */   
/*     */   public static final String XMLNS_NAMESPACE_PREFIX = "xmlns";
/*  33 */   public static final int XMLNS_NAMESPACE_PREFIX_LENGTH = "xmlns".length();
/*     */   public static final String XMLNS_NAMESPACE_NAME = "http://www.w3.org/2000/xmlns/";
/*  35 */   public static final int XMLNS_NAMESPACE_NAME_LENGTH = "http://www.w3.org/2000/xmlns/".length();
/*     */   
/*  37 */   public static final QualifiedName DEFAULT_NAMESPACE_DECLARATION = new QualifiedName("", "http://www.w3.org/2000/xmlns/", "xmlns", "xmlns");
/*     */   
...
/* 153 */   static final int[] OCTET_STRING_LENGTH_2ND_BIT_VALUES = new int[] { 65, 321, 64, 96 };
/*     */ 
/*     */   
...
/*     */   
/* 169 */   static final int[] OCTET_STRING_LENGTH_5TH_BIT_VALUES = new int[] { 9, 265, 8, 12 };
/*     */ 
/*     */   
...
/*     */   
/* 185 */   static final int[] OCTET_STRING_LENGTH_7TH_BIT_VALUES = new int[] { 3, 259, 2, 3 };
/*     */   
...
/* 216 */   static final int[] INTEGER_2ND_BIT_VALUES = new int[] { 64, 8256, 1048576, 64, 96, -1 };
/*     */ 
/*     */   
...
/*     */   
/* 239 */   static final int[] INTEGER_3RD_BIT_VALUES = new int[] { 32, 2080, 526368, 32, 40, 48 };
/*     */ 
/*     */   
...
/*     */   
/* 261 */   static final int[] INTEGER_4TH_BIT_VALUES = new int[] { 16, 1040, 263184, 16, 20, 24 };
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 270 */   static final byte[] BINARY_HEADER = new byte[] { -32, 0, 0, 1 };
/*     */   
/*     */   static byte[][] XML_DECLARATION_VALUES;
/*     */ 
/*     */   
/*     */   private static void initiateXMLDeclarationValues() {
/* 276 */     XML_DECLARATION_VALUES = new byte[9][];
/*     */     
/*     */     try {
/* 279 */       XML_DECLARATION_VALUES[0] = "<?xml encoding='finf'?>".getBytes("UTF-8");
/* 280 */       XML_DECLARATION_VALUES[1] = "<?xml version='1.0' encoding='finf'?>".getBytes("UTF-8");
/* 281 */       XML_DECLARATION_VALUES[2] = "<?xml version='1.1' encoding='finf'?>".getBytes("UTF-8");
/* 282 */       XML_DECLARATION_VALUES[3] = "<?xml encoding='finf' standalone='no'?>".getBytes("UTF-8");
/* 283 */       XML_DECLARATION_VALUES[4] = "<?xml encoding='finf' standalone='yes'?>".getBytes("UTF-8");
/* 284 */       XML_DECLARATION_VALUES[5] = "<?xml version='1.0' encoding='finf' standalone='no'?>".getBytes("UTF-8");
/* 285 */       XML_DECLARATION_VALUES[6] = "<?xml version='1.1' encoding='finf' standalone='no'?>".getBytes("UTF-8");
/* 286 */       XML_DECLARATION_VALUES[7] = "<?xml version='1.0' encoding='finf' standalone='yes'?>".getBytes("UTF-8");
/* 287 */       XML_DECLARATION_VALUES[8] = "<?xml version='1.1' encoding='finf' standalone='yes'?>".getBytes("UTF-8");
/* 288 */     } catch (UnsupportedEncodingException e) {}
/*     */   }
/*     */ }


/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\xml\fastinfoset\EncodingConstants.class
