...
/*  97 */   int[] bcs = new int[256];
/*  98 */   int[] gss = null;
/*     */   private static final int BUFFER_SIZE = 4096;
/* 100 */   private byte[] buffer = new byte[4096];
/* 101 */   private byte[] prevBuffer = new byte[4096];
/* 102 */   private BitSet lastPartFound = new BitSet(1);
/*     */ 
/*     */   
/* 105 */   private InputStream in = null;
...
/* 719 */             posVector[0] = pos;  break; }  this.buffer[i] = (byte)temp; }  bufferLength = i; }  return bufferLength; } public void writeTo(OutputStream os) throws IOException, MessagingException { if (this.in != null) {
/* 720 */       this.contentType.setParameter("boundary", this.boundary);
/*     */     }
/*     */     
/* 723 */     String bnd = "--" + this.contentType.getParameter("boundary");
/* 724 */     for (int i = 0; i < this.parts.size(); i++) {
/* 725 */       OutputUtil.writeln(bnd, os);
/* 726 */       ((MimeBodyPart)this.parts.get(i)).writeTo(os);
/* 727 */       OutputUtil.writeln(os);
/*     */     } 
/*     */     
/* 730 */     if (this.in != null)
/* 731 */     { OutputUtil.writeln(bnd, os);
/* 732 */       if (os instanceof ByteOutputStream && this.lazyAttachments) {
/* 733 */         ((ByteOutputStream)os).write(this.in);
/*     */       } else {
/* 735 */         ByteOutputStream baos = new ByteOutputStream(this.in.available());
/* 736 */         baos.write(this.in);
/* 737 */         baos.writeTo(os);
/*     */ 
/*     */         
/* 740 */         this.in = (InputStream)baos.newInputStream();
/*     */       }
/*     */        }
/*     */     
/*     */     else
/*     */     
/* 746 */     { OutputUtil.writeAsAscii(bnd, os);
/* 747 */       OutputUtil.writeAsAscii("--", os); }  }
...
/* 752 */           this.gss[--j] = i;  break; }  }  this.gss[l - 1] = 1; } public void setInputStream(InputStream is) { this.in = is; }
/*     */ 
/*     */   
...
/* 760 */     this.boundary = bnd;
/* 761 */     if (this.contentType != null)
/* 762 */       this.contentType.setParameter("boundary", bnd); 
/*     */   }
/*     */   
/*     */   public String getBoundary() {
/* 766 */     return this.boundary;
/*     */   }
/*     */   
...
/* 774 */     this.lazyAttachments = flag;
/*     */   }
/*     */ }


/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\xml\messaging\saaj\packaging\mime\internet\BMMimeMultipart.class
