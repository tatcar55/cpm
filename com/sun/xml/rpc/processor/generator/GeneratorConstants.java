...
public interface GeneratorConstants extends ModelerConstants, GeneratorConstants {
  ...
  public static final String REFERENCEABLE_SERIALIZER_NAME = "ReferenceableSerializerImpl";
  
  public static final String DYNAMIC_SERIALIZER_NAME = "DynamicSerializer";
  
  public static final String SIMPLE_TYPE_SERIALIZER_NAME = "SimpleTypeSerializer";
  
  public static final String SIMPLE_MULTI_TYPE_SERIALIZER_NAME = "SimpleMultiTypeSerializer";
  
  public static final String LITERAL_FRAGMENT_SERIALIZER_NAME = "LiteralFragmentSerializer";
  
  public static final String LITERAL_SIMPLE_TYPE_SERIALIZER_NAME = "LiteralSimpleTypeSerializer";
  
  public static final String ATTACHMENT_SERIALIZER_NAME = "AttachmentSerializer";
  
  public static final String COLLECTION_SERIALIZER_NAME = "CollectionSerializer";
  
  public static final String COLLECTION_INTERFACE_SERIALIZER_NAME = "CollectionInterfaceSerializer";
  
  public static final String MAP_SERIALIZER_NAME = "MapSerializer";
  
  public static final String MAP_INTERFACE_SERIALIZER_NAME = "MapInterfaceSerializer";
  
  public static final String JAX_RPC_MAP_ENTRY_SERIALIZER_NAME = "JAXRpcMapEntrySerializer";
  
  public static final String XSD_BASE64_BINARY_ENCODER_NAME = "XSDBase64BinaryEncoder";
  
  public static final String XSD_BOOLEAN_ENCODER_NAME = "XSDBooleanEncoder";
  
  public static final String XSD_BOXED_BASE64_BINARY_ENCODER_NAME = "XSDBoxedBase64BinaryEncoder";
  
  public static final String XSD_BOXED_HEX_BINARY_ENCODER_NAME = "XSDBoxedHexBinaryEncoder";
  
  public static final String XSD_BYTE_ENCODER_NAME = "XSDByteEncoder";
  
  public static final String XSD_DATE_TIME_CALENDAR_ENCODER_NAME = "XSDDateTimeCalendarEncoder";
  
  public static final String XSD_DATE_TIME_DATE_ENCODER_NAME = "XSDDateTimeDateEncoder";
  ...
  public static final String XSD_HEX_BINARY_ENCODER_NAME = "XSDHexBinaryEncoder";
  ...
  public static final String XSD_POSITIVE_INTEGER_ENCODER_NAME = "XSDPositiveIntegerEncoder";
  
  public static final String XSD_NEGATIVE_INTEGER_ENCODER_NAME = "XSDNegativeIntegerEncoder";
  
  public static final String XSD_NON_NEGATIVE_INTEGER_ENCODER_NAME = "XSDNonNegativeIntegerEncoder";
  
  public static final String XSD_NON_POSITIVE_INTEGER_ENCODER_NAME = "XSDNonPositiveIntegerEncoder";
  
  public static final String XSD_UNSIGNED_LONG_ENCODER_NAME = "XSDUnsignedLongEncoder";
  
  public static final String XSD_UNSIGNED_INT_ENCODER_NAME = "XSDUnsignedIntEncoder";
  
  public static final String XSD_UNSIGNED_SHORT_ENCODER_NAME = "XSDUnsignedShortEncoder";
  
  public static final String XSD_UNSIGNED_BYTE_ENCODER_NAME = "XSDUnsignedByteEncoder";
  
  public static final String XSD_LIST_TYPE_ENCODER_NAME = "XSDListTypeEncoder";
  
  public static final String IMAGE_ENCODER_NAME = "ImageAttachmentEncoder";
  
  public static final String MIME_MULTIPART_ENCODER_NAME = "MimeMultipartAttachmentEncoder";
  
  public static final String SOURCE_ENCODER_NAME = "SourceAttachmentEncoder";
  
  public static final String DATA_HANDLER_ENCODER_NAME = "DataHandlerAttachmentEncoder";
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\xml\rpc\processor\generator\GeneratorConstants.class
