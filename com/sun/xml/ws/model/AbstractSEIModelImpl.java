...
/* 510 */     this.additionalClasses = (List)new ArrayList<Class<?>>();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 522 */     this.methodToJM = new HashMap<Method, JavaMethodImpl>();
/*     */ 
/*     */ 
/*     */     
/* 526 */     this.nameToJM = new HashMap<QName, JavaMethodImpl>();
/*     */ 
/*     */ 
/*     */     
/* 530 */     this.wsdlOpToJM = new HashMap<QName, JavaMethodImpl>();
/*     */     
/* 532 */     this.javaMethods = new ArrayList<JavaMethodImpl>();
/* 533 */     this.bridgeMap = new HashMap<TypeReference, Bridge>();
/* 534 */     this.xmlBridgeMap = new HashMap<TypeInfo, XMLBridge>();
/* 535 */     this.emptyBodyName = new QName("");
/* 536 */     this.targetNamespace = "";
/* 537 */     this.knownNamespaceURIs = null;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 544 */     this.classLoader = null;
/*     */     this.features = features;
/*     */     this.databindingInfo = new BindingInfo();
/*     */     this.databindingInfo.setSEIModel(this);
/* 548 */   } private static final Logger LOGGER = Logger.getLogger(AbstractSEIModelImpl.class.getName());
/*     */   
/*     */   void postProcess() {
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\xml\ws\model\AbstractSEIModelImpl.class
