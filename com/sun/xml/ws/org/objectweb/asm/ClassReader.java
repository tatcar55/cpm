...
/*      */         break;
/*      */       case 66:
/* 1580 */         av.visit(name, new Byte((byte)readInt(this.items[readUnsignedShort(v)])));
/*      */         
/* 1582 */         v += 2;
/*      */         break;
/*      */       case 90:
...
/*      */         break;
/*      */       case 83:
/* 1591 */         av.visit(name, new Short((short)readInt(this.items[readUnsignedShort(v)])));
/*      */         
/* 1593 */         v += 2;
/*      */         break;
/*      */       case 67:
/* 1596 */         av.visit(name, new Character((char)readInt(this.items[readUnsignedShort(v)])));
/*      */         
/* 1598 */         v += 2;
/*      */         break;
/*      */       case 115:
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\xml\ws\org\objectweb\asm\ClassReader.class
