...
/*     */ @XmlType(name = "ParticipantsType", propOrder = {"primary", "participant", "any"})
...
/* 146 */     if (this.participant == null) {
/* 147 */       this.participant = new ArrayList<ParticipantType>();
/*     */     }
...
/* 176 */     if (this.any == null) {
/* 177 */       this.any = new ArrayList();
/*     */     }
/* 179 */     return this.any;
/*     */   }
/*     */ }
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\xml\ws\security\trust\impl\bindings\ParticipantsType.class
