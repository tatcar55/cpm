...
/*     */ import com.sun.xml.wss.saml.internal.saml11.jaxb10.AttributeDesignator;
...
/*     */ 
/*     */ public class AttributeDesignatorImpl extends AttributeDesignatorTypeImpl implements AttributeDesignator, RIElement, JAXBObject, UnmarshallableObject, XMLSerializable, ValidatableObject {
/*  16 */   public static final Class version = JAXBVersion.class;
/*     */   private static Grammar schemaFragment;
/*     */   
/*     */   private static final Class PRIMARY_INTERFACE_CLASS() {
/*  20 */     return AttributeDesignator.class;
/*     */   }
/*     */   
...
/*  38 */     context.startElement("urn:oasis:names:tc:SAML:1.0:assertion", "AttributeDesignator");
...
/*     */ 
/*     */     
/* 106 */     return (DocumentDeclaration)new REDocumentDeclaration(schemaFragment);
/*     */   }
/*     */   
/*     */   public class Unmarshaller
/*     */     extends AbstractUnmarshallingEventHandlerImpl
/*     */   {
/*     */     private final AttributeDesignatorImpl this$0;
/*     */     
...
/* 119 */       this(context);
/* 120 */       this.state = startState;
/*     */     }
/*     */     
/*     */     public Object owner() {
/* 124 */       return AttributeDesignatorImpl.this;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */         case 1:
/* 135 */           attIdx = this.context.getAttribute("", "AttributeName");
/* 136 */           if (attIdx >= 0) {
/* 137 */             this.context.consumeAttribute(attIdx);
/* 138 */             this.context.getCurrentHandler().enterElement(___uri, ___local, ___qname, __atts);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 0:
/* 143 */           if ("AttributeDesignator" == ___local && "urn:oasis:names:tc:SAML:1.0:assertion" == ___uri) {
/* 144 */             this.context.pushAttributes(__atts, false);
/* 145 */             this.state = 1;
/*     */             return;
/*     */           } 
/*     */           break;
...
/*     */         case 2:
/* 166 */           if ("AttributeDesignator" == ___local && "urn:oasis:names:tc:SAML:1.0:assertion" == ___uri) {
...
/*     */           break;
/*     */         case 1:
/* 173 */           attIdx = this.context.getAttribute("", "AttributeName");
/* 174 */           if (attIdx >= 0) {
...
/*     */         case 1:
/* 197 */           if ("AttributeName" == ___local && "" == ___uri) {
/* 198 */             AttributeDesignatorImpl.this.getClass(); spawnHandlerFromEnterAttribute((UnmarshallingEventHandler)new AttributeDesignatorTypeImpl.Unmarshaller(AttributeDesignatorImpl.this, this.context), 2, ___uri, ___local, ___qname);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 3:
...
/*     */         case 1:
/* 219 */           attIdx = this.context.getAttribute("", "AttributeName");
/* 220 */           if (attIdx >= 0) {
/* 221 */             this.context.consumeAttribute(attIdx);
/* 222 */             this.context.getCurrentHandler().leaveAttribute(___uri, ___local, ___qname);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 3:
...
/*     */           return;
/*     */       } 
/* 230 */       super.leaveAttribute(___uri, ___local, ___qname);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */           case 1:
/* 244 */             attIdx = this.context.getAttribute("", "AttributeName");
/* 245 */             if (attIdx >= 0) {
/* 246 */               this.context.consumeAttribute(attIdx);
/* 247 */               this.context.getCurrentHandler().text(value);
/*     */               return;
/*     */             } 
/*     */             break;
/*     */           case 3:
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\xml\wss\saml\internal\saml11\jaxb10\impl\AttributeDesignatorImpl.class
