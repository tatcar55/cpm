...
/*     */ import com.sun.xml.wss.saml.internal.saml11.jaxb10.AuthorityBinding;
...
/*     */ 
/*     */ public class AuthorityBindingImpl extends AuthorityBindingTypeImpl implements AuthorityBinding, RIElement, JAXBObject, UnmarshallableObject, XMLSerializable, ValidatableObject {
/*  16 */   public static final Class version = JAXBVersion.class;
/*     */   private static Grammar schemaFragment;
/*     */   
/*     */   private static final Class PRIMARY_INTERFACE_CLASS() {
/*  20 */     return AuthorityBinding.class;
/*     */   }
/*     */   
...
/*  38 */     context.startElement("urn:oasis:names:tc:SAML:1.0:assertion", "AuthorityBinding");
...
/*     */   {
/*     */     private final AuthorityBindingImpl this$0;
/*     */     
...
/* 116 */       this(context);
/* 117 */       this.state = startState;
/*     */     }
/*     */     
/*     */     public Object owner() {
/* 121 */       return AuthorityBindingImpl.this;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */         case 0:
/* 132 */           if ("AuthorityBinding" == ___local && "urn:oasis:names:tc:SAML:1.0:assertion" == ___uri) {
/* 133 */             this.context.pushAttributes(__atts, false);
/* 134 */             this.state = 1;
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 1:
/* 139 */           attIdx = this.context.getAttribute("", "AuthorityKind");
/* 140 */           if (attIdx >= 0) {
...
/*     */         case 1:
/* 163 */           attIdx = this.context.getAttribute("", "AuthorityKind");
/* 164 */           if (attIdx >= 0) {
/* 165 */             this.context.consumeAttribute(attIdx);
/* 166 */             this.context.getCurrentHandler().leaveElement(___uri, ___local, ___qname);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 3:
...
/*     */           return;
/*     */         case 2:
/* 174 */           if ("AuthorityBinding" == ___local && "urn:oasis:names:tc:SAML:1.0:assertion" == ___uri) {
...
/*     */         case 1:
/* 194 */           if ("AuthorityKind" == ___local && "" == ___uri) {
/* 195 */             AuthorityBindingImpl.this.getClass(); spawnHandlerFromEnterAttribute((UnmarshallingEventHandler)new AuthorityBindingTypeImpl.Unmarshaller(AuthorityBindingImpl.this, this.context), 2, ___uri, ___local, ___qname);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 3:
...
/*     */         case 1:
/* 216 */           attIdx = this.context.getAttribute("", "AuthorityKind");
/* 217 */           if (attIdx >= 0) {
/* 218 */             this.context.consumeAttribute(attIdx);
/* 219 */             this.context.getCurrentHandler().leaveAttribute(___uri, ___local, ___qname);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 3:
/* 224 */           revertToParentFromLeaveAttribute(___uri, ___local, ___qname);
/*     */           return;
/*     */       } 
...
/*     */           case 1:
/* 241 */             attIdx = this.context.getAttribute("", "AuthorityKind");
/* 242 */             if (attIdx >= 0) {
/* 243 */               this.context.consumeAttribute(attIdx);
/* 244 */               this.context.getCurrentHandler().text(value);
/*     */               return;
/*     */             } 
/*     */             break;
/*     */           case 3:
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\xml\wss\saml\internal\saml11\jaxb10\impl\AuthorityBindingImpl.class
