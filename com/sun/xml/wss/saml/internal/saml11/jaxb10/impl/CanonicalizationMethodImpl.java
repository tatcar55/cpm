...
/*     */ import com.sun.xml.wss.saml.internal.saml11.jaxb10.CanonicalizationMethod;
...
/*     */ 
/*     */ public class CanonicalizationMethodImpl extends CanonicalizationMethodTypeImpl implements CanonicalizationMethod, RIElement, JAXBObject, UnmarshallableObject, XMLSerializable, ValidatableObject {
/*  16 */   public static final Class version = JAXBVersion.class;
/*     */   private static Grammar schemaFragment;
/*     */   
/*     */   private static final Class PRIMARY_INTERFACE_CLASS() {
/*  20 */     return CanonicalizationMethod.class;
/*     */   }
/*     */   
...
/*  28 */     return "CanonicalizationMethod";
/*     */   }
/*     */   
...
/*  38 */     context.startElement("http://www.w3.org/2000/09/xmldsig#", "CanonicalizationMethod");
...
/*     */   {
/*     */     private final CanonicalizationMethodImpl this$0;
/*     */     
...
/*     */     
/*     */     public Object owner() {
/* 128 */       return CanonicalizationMethodImpl.this;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */         case 1:
/* 139 */           attIdx = this.context.getAttribute("", "Algorithm");
/* 140 */           if (attIdx >= 0) {
/* 141 */             this.context.consumeAttribute(attIdx);
/* 142 */             this.context.getCurrentHandler().enterElement(___uri, ___local, ___qname, __atts);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 3:
...
/*     */           return;
/*     */         case 0:
/* 150 */           if ("CanonicalizationMethod" == ___local && "http://www.w3.org/2000/09/xmldsig#" == ___uri) {
...
/*     */         case 1:
/* 170 */           attIdx = this.context.getAttribute("", "Algorithm");
/* 171 */           if (attIdx >= 0) {
/* 172 */             this.context.consumeAttribute(attIdx);
/* 173 */             this.context.getCurrentHandler().leaveElement(___uri, ___local, ___qname);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 3:
...
/*     */           return;
/*     */         case 2:
/* 181 */           if ("CanonicalizationMethod" == ___local && "http://www.w3.org/2000/09/xmldsig#" == ___uri) {
...
/*     */         case 1:
/* 201 */           if ("Algorithm" == ___local && "" == ___uri) {
/* 202 */             CanonicalizationMethodImpl.this.getClass(); spawnHandlerFromEnterAttribute((UnmarshallingEventHandler)new CanonicalizationMethodTypeImpl.Unmarshaller(CanonicalizationMethodImpl.this, this.context), 2, ___uri, ___local, ___qname);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 3:
...
/*     */         case 1:
/* 223 */           attIdx = this.context.getAttribute("", "Algorithm");
/* 224 */           if (attIdx >= 0) {
/* 225 */             this.context.consumeAttribute(attIdx);
/* 226 */             this.context.getCurrentHandler().leaveAttribute(___uri, ___local, ___qname);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 3:
...
/*     */           case 1:
/* 248 */             attIdx = this.context.getAttribute("", "Algorithm");
/* 249 */             if (attIdx >= 0) {
/* 250 */               this.context.consumeAttribute(attIdx);
/* 251 */               this.context.getCurrentHandler().text(value);
/*     */               return;
/*     */             } 
/*     */             break;
/*     */           case 3:
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\xml\wss\saml\internal\saml11\jaxb10\impl\CanonicalizationMethodImpl.class
