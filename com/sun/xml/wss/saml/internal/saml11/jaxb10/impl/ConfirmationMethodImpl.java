...
/*     */ 
/*     */ public class ConfirmationMethodImpl implements ConfirmationMethod, RIElement, JAXBObject, UnmarshallableObject, XMLSerializable, ValidatableObject {
...
/*     */   
/*     */   public ConfirmationMethodImpl(String value) {
/*  22 */     this._Value = value;
/*     */   }
/*     */   
/*     */   private static final Class PRIMARY_INTERFACE_CLASS() {
/*  26 */     return ConfirmationMethod.class;
/*     */   }
/*     */   
...
/*  52 */     context.startElement("urn:oasis:names:tc:SAML:1.0:assertion", "ConfirmationMethod");
...
/*     */   {
/*     */     private final ConfirmationMethodImpl this$0;
/*     */     
...
/*     */     
/*     */     public Object owner() {
/* 135 */       return ConfirmationMethodImpl.this;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */           return;
/*     */         case 0:
/* 149 */           if ("ConfirmationMethod" == ___local && "urn:oasis:names:tc:SAML:1.0:assertion" == ___uri) {
...
/*     */         case 2:
/* 169 */           if ("ConfirmationMethod" == ___local && "urn:oasis:names:tc:SAML:1.0:assertion" == ___uri) {
...
/*     */       try {
/* 243 */         ConfirmationMethodImpl.this._Value = WhiteSpaceProcessor.collapse(value);
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\xml\wss\saml\internal\saml11\jaxb10\impl\ConfirmationMethodImpl.class
