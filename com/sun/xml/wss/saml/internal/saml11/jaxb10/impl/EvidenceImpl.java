...
/*     */ import com.sun.xml.wss.saml.internal.saml11.jaxb10.Evidence;
...
/*     */ 
/*     */ public class EvidenceImpl extends EvidenceTypeImpl implements Evidence, RIElement, JAXBObject, UnmarshallableObject, XMLSerializable, ValidatableObject {
/*  16 */   public static final Class version = JAXBVersion.class;
/*     */   private static Grammar schemaFragment;
/*     */   
/*     */   private static final Class PRIMARY_INTERFACE_CLASS() {
/*  20 */     return Evidence.class;
/*     */   }
/*     */   
...
/*  38 */     context.startElement("urn:oasis:names:tc:SAML:1.0:assertion", "Evidence");
...
/*     */   {
/*     */     private final EvidenceImpl this$0;
/*     */     
...
/*     */         case 3:
/* 138 */           revertToParentFromEnterElement(___uri, ___local, ___qname, __atts);
/*     */           return;
/*     */         case 1:
/* 141 */           if ("AssertionIDReference" == ___local && "urn:oasis:names:tc:SAML:1.0:assertion" == ___uri) {
/* 142 */             EvidenceImpl.this.getClass(); spawnHandlerFromEnterElement((UnmarshallingEventHandler)new EvidenceTypeImpl.Unmarshaller(EvidenceImpl.this, this.context), 2, ___uri, ___local, ___qname, __atts);
/*     */             return;
/*     */           } 
/* 145 */           if ("Assertion" == ___local && "urn:oasis:names:tc:SAML:1.0:assertion" == ___uri) {
/* 146 */             EvidenceImpl.this.getClass(); spawnHandlerFromEnterElement((UnmarshallingEventHandler)new EvidenceTypeImpl.Unmarshaller(EvidenceImpl.this, this.context), 2, ___uri, ___local, ___qname, __atts);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 0:
/* 151 */           if ("Evidence" == ___local && "urn:oasis:names:tc:SAML:1.0:assertion" == ___uri) {
/* 152 */             this.context.pushAttributes(__atts, false);
/* 153 */             this.state = 1;
/*     */             return;
/*     */           } 
/*     */           break;
...
/*     */           return;
/*     */         case 2:
/* 174 */           if ("Evidence" == ___local && "urn:oasis:names:tc:SAML:1.0:assertion" == ___uri) {
...
/* 231 */         handleUnexpectedTextException(value, e);
/*     */       } 
/*     */     }
/*     */   }
/*     */ }
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\xml\wss\saml\internal\saml11\jaxb10\impl\EvidenceImpl.class
