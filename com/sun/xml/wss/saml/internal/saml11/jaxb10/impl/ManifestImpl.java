...
/*     */ import com.sun.xml.wss.saml.internal.saml11.jaxb10.Manifest;
...
/*     */ 
/*     */ public class ManifestImpl extends ManifestTypeImpl implements Manifest, RIElement, JAXBObject, UnmarshallableObject, XMLSerializable, ValidatableObject {
/*  16 */   public static final Class version = JAXBVersion.class;
/*     */   private static Grammar schemaFragment;
/*     */   
/*     */   private static final Class PRIMARY_INTERFACE_CLASS() {
/*  20 */     return Manifest.class;
/*     */   }
/*     */   
...
/*  38 */     context.startElement("http://www.w3.org/2000/09/xmldsig#", "Manifest");
...
/*     */   {
/*     */     private final ManifestImpl this$0;
/*     */     
...
/*     */         case 0:
/* 144 */           if ("Manifest" == ___local && "http://www.w3.org/2000/09/xmldsig#" == ___uri) {
...
/*     */           break;
/*     */         case 1:
/* 151 */           attIdx = this.context.getAttribute("", "Id");
/* 152 */           if (attIdx >= 0) {
/* 153 */             this.context.consumeAttribute(attIdx);
/* 154 */             this.context.getCurrentHandler().enterElement(___uri, ___local, ___qname, __atts);
/*     */             return;
/*     */           } 
/* 157 */           if ("Reference" == ___local && "http://www.w3.org/2000/09/xmldsig#" == ___uri) {
/* 158 */             ManifestImpl.this.getClass(); spawnHandlerFromEnterElement((UnmarshallingEventHandler)new ManifestTypeImpl.Unmarshaller(ManifestImpl.this, this.context), 2, ___uri, ___local, ___qname, __atts);
/*     */             return;
/*     */           } 
/* 161 */           if ("Reference" == ___local && "http://www.w3.org/2000/09/xmldsig#" == ___uri) {
/* 162 */             ManifestImpl.this.getClass(); spawnHandlerFromEnterElement((UnmarshallingEventHandler)new ManifestTypeImpl.Unmarshaller(ManifestImpl.this, this.context), 2, ___uri, ___local, ___qname, __atts);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 3:
/* 167 */           revertToParentFromEnterElement(___uri, ___local, ___qname, __atts);
/*     */           return;
/*     */       } 
...
/*     */         case 1:
/* 183 */           attIdx = this.context.getAttribute("", "Id");
/* 184 */           if (attIdx >= 0) {
...
/*     */           break;
/*     */         case 2:
/* 191 */           if ("Manifest" == ___local && "http://www.w3.org/2000/09/xmldsig#" == ___uri) {
...
/*     */           return;
/*     */       } 
/* 201 */       super.leaveElement(___uri, ___local, ___qname);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */         case 1:
/* 214 */           if ("Id" == ___local && "" == ___uri) {
/* 215 */             ManifestImpl.this.getClass(); spawnHandlerFromEnterAttribute((UnmarshallingEventHandler)new ManifestTypeImpl.Unmarshaller(ManifestImpl.this, this.context), 2, ___uri, ___local, ___qname);
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 3:
...
/*     */         case 1:
/* 236 */           attIdx = this.context.getAttribute("", "Id");
/* 237 */           if (attIdx >= 0) {
...
/*     */           return;
/*     */       } 
/* 247 */       super.leaveAttribute(___uri, ___local, ___qname);
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 264 */               this.context.getCurrentHandler().text(value);
/*     */               return;
/*     */             } 
/*     */             break;
/*     */           case 3:
...
/* 273 */         handleUnexpectedTextException(value, e);
/*     */       } 
/*     */     }
/*     */   }
/*     */ }
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\xml\wss\saml\internal\saml11\jaxb10\impl\ManifestImpl.class
