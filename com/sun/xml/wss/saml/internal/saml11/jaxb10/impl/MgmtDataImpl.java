...
/*     */ import com.sun.xml.wss.saml.internal.saml11.jaxb10.MgmtData;
...
/*     */ 
/*     */ public class MgmtDataImpl implements MgmtData, RIElement, JAXBObject, UnmarshallableObject, XMLSerializable, ValidatableObject {
...
/*     */   public MgmtDataImpl() {}
/*     */   
/*     */   public MgmtDataImpl(String value) {
/*  22 */     this._Value = value;
/*     */   }
/*     */   
/*     */   private static final Class PRIMARY_INTERFACE_CLASS() {
/*  26 */     return MgmtData.class;
/*     */   }
/*     */   
...
/*  52 */     context.startElement("http://www.w3.org/2000/09/xmldsig#", "MgmtData");
...
/*     */   {
/*     */     private final MgmtDataImpl this$0;
/*     */     
...
/*     */         case 0:
/* 148 */           if ("MgmtData" == ___local && "http://www.w3.org/2000/09/xmldsig#" == ___uri) {
...
/*     */         case 2:
/* 171 */           if ("MgmtData" == ___local && "http://www.w3.org/2000/09/xmldsig#" == ___uri) {
...
/*     */       try {
/* 245 */         MgmtDataImpl.this._Value = value;
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\xml\wss\saml\internal\saml11\jaxb10\impl\MgmtDataImpl.class
