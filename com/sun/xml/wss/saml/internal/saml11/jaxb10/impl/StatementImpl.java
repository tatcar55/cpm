...
/*     */ 
/*     */ public class StatementImpl extends StatementAbstractTypeImpl implements Statement, RIElement, JAXBObject, UnmarshallableObject, XMLSerializable, ValidatableObject {
/*  16 */   public static final Class version = JAXBVersion.class;
/*     */   private static Grammar schemaFragment;
/*     */   
/*     */   private static final Class PRIMARY_INTERFACE_CLASS() {
/*  20 */     return Statement.class;
/*     */   }
/*     */   
...
/*  38 */     context.startElement("urn:oasis:names:tc:SAML:1.0:assertion", "Statement");
...
/*     */         case 0:
/* 127 */           if ("Statement" == ___local && "urn:oasis:names:tc:SAML:1.0:assertion" == ___uri) {
/* 128 */             this.context.pushAttributes(__atts, false);
/* 129 */             this.state = 1;
/*     */             return;
/*     */           } 
/*     */           break;
/*     */         case 1:
/* 134 */           StatementImpl.this.getClass(); spawnHandlerFromEnterElement((UnmarshallingEventHandler)new StatementAbstractTypeImpl.Unmarshaller(StatementImpl.this, this.context), 2, ___uri, ___local, ___qname, __atts);
/*     */           return;
/*     */         case 3:
...
/*     */         case 1:
/* 153 */           StatementImpl.this.getClass(); spawnHandlerFromLeaveElement((UnmarshallingEventHandler)new StatementAbstractTypeImpl.Unmarshaller(StatementImpl.this, this.context), 2, ___uri, ___local, ___qname);
/*     */           return;
/*     */         case 2:
/* 156 */           if ("Statement" == ___local && "urn:oasis:names:tc:SAML:1.0:assertion" == ___uri) {
...
/*     */         case 1:
/* 179 */           StatementImpl.this.getClass(); spawnHandlerFromEnterAttribute((UnmarshallingEventHandler)new StatementAbstractTypeImpl.Unmarshaller(StatementImpl.this, this.context), 2, ___uri, ___local, ___qname);
/*     */           return;
/*     */         case 3:
...
/*     */         case 1:
/* 198 */           StatementImpl.this.getClass(); spawnHandlerFromLeaveAttribute((UnmarshallingEventHandler)new StatementAbstractTypeImpl.Unmarshaller(StatementImpl.this, this.context), 2, ___uri, ___local, ___qname);
/*     */           return;
/*     */         case 3:
...
/*     */           case 1:
/* 218 */             StatementImpl.this.getClass(); spawnHandlerFromText((UnmarshallingEventHandler)new StatementAbstractTypeImpl.Unmarshaller(StatementImpl.this, this.context), 2, value);
/*     */             return;
/*     */           case 3:
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\xml\wss\saml\internal\saml11\jaxb10\impl\StatementImpl.class
