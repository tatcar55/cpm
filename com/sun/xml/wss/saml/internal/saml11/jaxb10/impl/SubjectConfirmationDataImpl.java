...
/*     */ import com.sun.xml.wss.saml.internal.saml11.jaxb10.SubjectConfirmationData;
...
/*     */ 
/*     */ public class SubjectConfirmationDataImpl extends AnyTypeImpl implements SubjectConfirmationData, RIElement, JAXBObject, UnmarshallableObject, XMLSerializable, ValidatableObject {
/*  16 */   public static final Class version = JAXBVersion.class;
/*     */   private static Grammar schemaFragment;
/*     */   
/*     */   private static final Class PRIMARY_INTERFACE_CLASS() {
/*  20 */     return SubjectConfirmationData.class;
/*     */   }
/*     */   
...
/*  28 */     return "SubjectConfirmationData";
/*     */   }
/*     */   
...
/*  38 */     context.startElement("urn:oasis:names:tc:SAML:1.0:assertion", "SubjectConfirmationData");
...
/*     */   {
/*     */     private final SubjectConfirmationDataImpl this$0;
/*     */     
...
/*     */     
/*     */     public Object owner() {
/* 125 */       return SubjectConfirmationDataImpl.this;
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/*     */         case 0:
/* 136 */           if ("SubjectConfirmationData" == ___local && "urn:oasis:names:tc:SAML:1.0:assertion" == ___uri) {
...
/*     */         
/*     */         case 1:
/* 144 */           SubjectConfirmationDataImpl.this.getClass(); spawnHandlerFromEnterElement((UnmarshallingEventHandler)new AnyTypeImpl.Unmarshaller(SubjectConfirmationDataImpl.this, this.context), 2, ___uri, ___local, ___qname, __atts);
/*     */           return;
/*     */ 
/*     */ 
/*     */         
...
/*     */         case 1:
/* 166 */           SubjectConfirmationDataImpl.this.getClass(); spawnHandlerFromLeaveElement((UnmarshallingEventHandler)new AnyTypeImpl.Unmarshaller(SubjectConfirmationDataImpl.this, this.context), 2, ___uri, ___local, ___qname);
/*     */           return;
/*     */         case 2:
/* 169 */           if ("SubjectConfirmationData" == ___local && "urn:oasis:names:tc:SAML:1.0:assertion" == ___uri) {
...
/*     */         case 1:
/* 192 */           SubjectConfirmationDataImpl.this.getClass(); spawnHandlerFromEnterAttribute((UnmarshallingEventHandler)new AnyTypeImpl.Unmarshaller(SubjectConfirmationDataImpl.this, this.context), 2, ___uri, ___local, ___qname);
/*     */           return;
/*     */         case 3:
...
/*     */         case 1:
/* 211 */           SubjectConfirmationDataImpl.this.getClass(); spawnHandlerFromLeaveAttribute((UnmarshallingEventHandler)new AnyTypeImpl.Unmarshaller(SubjectConfirmationDataImpl.this, this.context), 2, ___uri, ___local, ___qname);
/*     */           return;
/*     */         case 3:
/* 214 */           revertToParentFromLeaveAttribute(___uri, ___local, ___qname);
/*     */           return;
/*     */       } 
...
/*     */           case 1:
/* 231 */             SubjectConfirmationDataImpl.this.getClass(); spawnHandlerFromText((UnmarshallingEventHandler)new AnyTypeImpl.Unmarshaller(SubjectConfirmationDataImpl.this, this.context), 2, value);
/*     */             return;
/*     */           case 3:
/* 234 */             revertToParentFromText(value);
/*     */             return;
/*     */         } 
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\com\sun\xml\wss\saml\internal\saml11\jaxb10\impl\SubjectConfirmationDataImpl.class
