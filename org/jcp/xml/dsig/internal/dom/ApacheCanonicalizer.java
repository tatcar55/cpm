...
public abstract class ApacheCanonicalizer extends TransformService {
  ...
  public Data transform(Data paramData, XMLCryptoContext paramXMLCryptoContext, OutputStream paramOutputStream) throws TransformException {
    ...
    try {
      ...
      return (Data)((!xMLSignatureInput.isNodeSet() && !xMLSignatureInput.isElement()) ? null : (xMLSignatureInput.isOctetStream() ? new ApacheOctetStreamData(xMLSignatureInput) : new ApacheNodeSetData(xMLSignatureInput)));
    } catch (Exception exception) {
      throw new TransformException(exception);
    } 
  }
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\org\jcp\xml\dsig\internal\dom\ApacheCanonicalizer.class
