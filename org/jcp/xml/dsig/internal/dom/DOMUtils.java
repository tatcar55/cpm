...
public class DOMUtils {
  public static Document getOwnerDocument(Node paramNode) {
    return (paramNode.getNodeType() == 9) ? (Document)paramNode : paramNode.getOwnerDocument();
  }
  ...
  public static String getNSPrefix(XMLCryptoContext paramXMLCryptoContext, String paramString) {
    return (paramXMLCryptoContext != null) ? paramXMLCryptoContext.getNamespacePrefix(paramString, paramXMLCryptoContext.getDefaultNamespacePrefix()) : null;
  }
  ...
  public static boolean nodesEqual(Node paramNode1, Node paramNode2) {
    return (paramNode1 == paramNode2) ? true : (!(paramNode1.getNodeType() != paramNode2.getNodeType()));
  }
  ...
  private static boolean paramsEqual(XPathFilter2ParameterSpec paramXPathFilter2ParameterSpec1, XPathFilter2ParameterSpec paramXPathFilter2ParameterSpec2) {
    ...
    if (i != list2.size())
      return false; 
    for (byte b = 0; b < i; b++) {
      XPathType xPathType1 = list1.get(b);
      XPathType xPathType2 = list2.get(b);
  ...
  static class NodeSet extends AbstractSet {
    ...
    public Iterator iterator() {
      return new Iterator() {
          ...
          private final DOMUtils.NodeSet this$0;
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\org\jcp\xml\dsig\internal\dom\DOMUtils.class
