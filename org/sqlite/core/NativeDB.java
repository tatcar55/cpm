...
/* 144 */     return utf8ByteArrayToString(errmsg_utf8());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 154 */     return utf8ByteArrayToString(libversion_utf8());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 218 */     return utf8ByteArrayToString(column_decltype_utf8(stmt, col));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 228 */     return utf8ByteArrayToString(column_table_name_utf8(stmt, col));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 239 */     return utf8ByteArrayToString(column_name_utf8(stmt, col));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 249 */     return utf8ByteArrayToString(column_text_utf8(stmt, col));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 373 */     return utf8ByteArrayToString(value_text_utf8(f, arg));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 439 */     return backup(stringToUtf8ByteArray(dbName), stringToUtf8ByteArray(destFileName), observer);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 453 */     return restore(stringToUtf8ByteArray(dbName), stringToUtf8ByteArray(sourceFileName), observer);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 478 */     throw new SQLException(msg);
/*     */   }
/*     */   
...
/*     */     }
/*     */     try {
/* 486 */       return str.getBytes("UTF-8");
/*     */     }
/* 488 */     catch (UnsupportedEncodingException e) {
/* 489 */       throw new RuntimeException("UTF-8 is not supported", e);
/*     */     } 
/*     */   }
/*     */   
/*     */   static String utf8ByteArrayToString(byte[] utf8bytes) {
/* 494 */     if (utf8bytes == null) {
/* 495 */       return null;
/*     */     }
/*     */     try {
/* 498 */       return new String(utf8bytes, "UTF-8");
/*     */     }
/* 500 */     catch (UnsupportedEncodingException e) {
/* 501 */       throw new RuntimeException("UTF-8 is not supported", e);
/*     */     } 
/*     */   }
/*     */   
...
/*     */   
/*     */   synchronized native byte[] column_decltype_utf8(long paramLong, int paramInt);
/*     */   
/*     */   synchronized native byte[] column_table_name_utf8(long paramLong, int paramInt);
/*     */   
/*     */   synchronized native byte[] column_name_utf8(long paramLong, int paramInt);
/*     */   
/*     */   synchronized native byte[] column_text_utf8(long paramLong, int paramInt);
/*     */   
...
/*     */   
/*     */   synchronized native byte[] value_text_utf8(Function paramFunction, int paramInt);
/*     */   
...
/* Location:              C:\Users\carlos\Documents\InnoExtractor\Cyber Password Manager 1_0\{app}\cpm_1.0.jar!\org\sqlite\core\NativeDB.class
